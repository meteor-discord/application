...
module.exports = {
  ...
  run: async (context, args) => {
    ...
    if (matches.length) {
      ...
      if(!currentPlatform && Object.keys(res.data.platforms).length >= 1) currentPlatform = Object.keys(res.data.platforms)[0]
      ...
      let selectTypeOptions = platforms.splice(0, 25).sort().map((r) => {
