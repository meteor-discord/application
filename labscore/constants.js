...
module.exports.GUILD_FEATURES = Object.freeze({
  ...
  APPLICATION_COMMAND_PERMISSIONS_V2: {
    icon: this.GUILD_FEATURE_ICONS_REDESIGN.SlashBoxIcon,
    label: 'New Slash Command Permissions',
  },
  ...
  GUILD_COMMUNICATION_DISABLED_GUILDS: {
    icon: this.GUILD_FEATURE_ICONS_REDESIGN.ClockWarningIcon,
    label: 'Timeouts enabled',
  },
  GUILD_HOME_DEPRECATION_OVERRIDE: {
    icon: this.GUILD_FEATURE_ICONS_REDESIGN.HomeIcon,
    label: 'Home Deprecation Override',
  },
  ...
  GUILD_ROLE_SUBSCRIPTION_PURCHASE_FEEDBACK_LOOP: {
    icon: this.GUILD_FEATURE_ICONS_REDESIGN.BadgeIcon,
    label: 'Role Subscriptions Feedback',
  },
  GUILD_ROLE_SUBSCRIPTION_TIER_TEMPLATE: {
    icon: this.GUILD_FEATURE_ICONS_REDESIGN.BadgeIcon,
    label: 'Role Subscriptions Tier Template',
  },
  GUILD_ROLE_SUBSCRIPTION_TRIALS: {
    icon: this.GUILD_FEATURE_ICONS_REDESIGN.BadgeIcon,
    label: 'Role Subscriptions Trials',
  },
  ...
  MOBILE_WEB_ROLE_SUBSCRIPTION_PURCHASE_PAGE: {
    icon: this.GUILD_FEATURE_ICONS_REDESIGN.BrowserIcon,
    label: 'Role Subscriptions Web Page enabled',
  },
