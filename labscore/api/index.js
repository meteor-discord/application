...
module.exports.maps = async function(context, query){
  return await request(Api.SEARCH_GOOGLE_MAPS, "GET", {}, {
    q: query
  })
}

module.exports.mapsSupplemental = async function(context, supplementalKey){
  return await request(Api.SEARCH_GOOGLE_MAPS_SUPPLEMENTAL, "GET", {}, {
    supplemental_key: supplementalKey
  })
}
...
module.exports.inhouseEmojiSearch = async function(context, emoji, codepoint = undefined){
  return await request(Api.UTILS_EMOJI_SEARCH, "GET", {}, {
    q: emoji,
    with_metadata: "",
    codepoint
  })
...
module.exports.grok = async function(context, prompt, input, model = "grok-4", image){
    return await request(Api.UTILS_GROK, "GET", {}, {
        prompt,
        input,
        model,
...
module.exports.unicodeMetadata = async function(context, string){
  return await request(Api.UTILS_UNICODE_METADATA, "GET", {}, {
    q: string
  })
}

module.exports.webshot = async function(context, url, nsfw){
    return await request(Api.UTILS_WEBSHOT, "GET", {}, {
        url: url,
        nsfw: nsfw
    })
}
